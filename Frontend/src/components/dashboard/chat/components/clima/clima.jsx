...
export default function Clima({ open, onClose }) {
  ...
  async function obtenerClima() {
    ...
    try {
      ...
      const message =
        e?.code === 1
          ? "Necesitamos permiso de ubicacion para mostrar el clima."
      ...
      >
        {loading && (
          ...
          >
            <Typography
              variant="h2"
              sx={{ fontSize: "1rem", fontFamily: "'Lora', serif", color: "#000000" }}
            >
              Cargando clima...
            </Typography>
          ...
          <>
            ...
            >
              <Box>
                <Box
                  component="img"
                  src={weatherData.icon || "/icon-512.png"}
                  alt={weatherData.condition || "clima"}
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              <Grid item size={6}>
                ...
                >
                  ...
                  <Typography variant="body2">Sensacion</Typography>
              ...
              <Grid item size={6}>
                ...
                >
                  ...
                  <Typography variant="body2">Indice UV</Typography>
              ...
              <Grid item size={12}>
                ...
                >
                  ...
                  <Typography variant="body1">
                    {weatherData.chanceOfRain != null
                      ? `Probabilidad de lluvia: ${weatherData.chanceOfRain}%`
                      : weatherData.condition}
                  </Typography>
                </Box>
              </Grid>
